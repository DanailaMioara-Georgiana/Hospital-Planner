...
public class ClientThread extends Thread {
    ...
    /**
     * preia datele unui doctor care urmeaza sa fie inserat
     *
     * @throws IOException
     */
    public synchronized void insertDoctorRequest() throws IOException {
        ...
        System.out.println(doctor.getPrenume());
    ...
    /**
     * preia datele necesare stergerii unui doctor
     *
     * @throws IOException
     */
    ...
    /**
     * preia datele necesare stergerii unui pacient
     *
     * @throws IOException
     */
    ...
    /**
     * preia datele necesare actualizarii unui medic
     *
     * @throws IOException
     */
    ...
    /**
     * preia datele necesare actualizarii unei programari a unui pacient
     *
     * @throws IOException
     */
    ...
    /**
     * preia datele necesare conectarii unui utilizator
     *
     * @throws IOException
     */
    ...
    public synchronized void insertPatientRequest() throws IOException {
        ...
        try {
            ...
            Patient patient = new Patient();
            inputLine = input.readLine();
            System.out.println(inputLine + "asta e nume");
            patient.setNume(inputLine);
            inputLine = input.readLine();
            System.out.println(inputLine + "asta e prenume");
            patient.setPrenume(inputLine);
            inputLine = input.readLine();
            System.out.println(inputLine + "asta e tel");
            patient.setTelefon(inputLine);
            patient.setDoctor(doctor);
            System.out.println(patient.getDoctor().getId());
            inputLine = input.readLine();
            System.out.println(inputLine + "asta e ora");
            patient.setOra(inputLine);
            inputLine = input.readLine();
            System.out.println(inputLine + "asta e data");
            patient.setData(inputLine);

            try {
                Patient sameProgram = patientRepository.findByDoctorDateAndHour(patient.getDoctor().getId(), patient.getData(), patient.getOra());
                System.out.println(sameProgram.getNume());
